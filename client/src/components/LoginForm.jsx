      ...
      <div className='flex-1 flex items-center justify-center p-6 sm:p-12 bg-white'>
        ...
        <form className='space-y-5' onSubmit={handleSubmit}>
          <div>
            ...
            <input type="email" value={email} onChange={(e)=> setEmail(e.target.value)} required placeholder='himu@gmail.com'/>
          </div>
          ...
          <div>
            ...
            <button type='button' className='absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition-colors' onClick={()=>setShoePassword(!showPassword)}>
