        ...
        <div className='card p-5 sm:p-6'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                ...
                <div className='sm:col-span-2'>
                    ...
                    <textarea name='bio' required defaultValue={initialData?.bio} rows={3} className='resize-none' placeholder='Breif description....' />
                </div>
        ...
        <div className='card p-5 sm:p-6'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                ...
                {isEditMode && (
                    ...
                    <select name='employmentStatus' min="0" step="0.01" defaultValue={initialData?.employmentStatus}>
