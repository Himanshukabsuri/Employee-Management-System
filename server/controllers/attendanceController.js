...
export const clockInOut = async(req,res)=>{
    try {
        ...
        if (!existing) {
            ...
            const attendeance = await Attendance.create({
                employeeId:employee._id,
                date:today,
                checkIn:now,
            ...
            await inngest.send({
                ...
                data:{
                    employeeId:employee._id,
                    attendeanceId:attendeance._id,
                    
                }
            })

            return res.json({success:true,type:"CHECK_IN",date:attendeance});
